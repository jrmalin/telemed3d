 ...
 * Example usage: Mesh myMesh = ObjImporter2.Instance.ImportFile("path_to_obj_file.obj");
 */
...
public sealed class ObjImporter2
{

    #region singleton
    // Singleton code
    // Static can be called from anywhere without having to make an instance
    private static ObjImporter2 _instance;

    // If called check if there is an instance, otherwise create it
    public static ObjImporter2 Instance
    {
        get { return _instance ?? (_instance = new ObjImporter2()); }
    }
    #endregion
